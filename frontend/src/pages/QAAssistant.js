  ...
  const handleSendMessage = async (messageText) => {
    ...
    try {
      const response = await api.post(
        `/ai/documents/${selectedDocumentId}/ask`,
        {
          question: text,
          prefer: aiMode,
        },
          ...
          {loading ? (
            ...
            <DocumentSelectorCard>
              <Box sx={{ textAlign: "center", py: 4 }}>
                <FolderOpen
                  sx={{ fontSize: 64, color: "rgba(79, 172, 254, 0.5)", mb: 2 }}
                />
              ...
              <MessagesArea>
                {!chatStarted && (
                  <Box sx={{ textAlign: "center", py: 4 }}>
                    ...
                    >
                      I'll analyze "{selectedDocument.original_filename}" and
                      answer your questions using{" "}
                      {aiMode === "groq" ? "Cloud AI" : "Local AI"}.
                    </Typography>
                    <Box
                      sx={{
                        display: "flex",
                    ...
                    <Box sx={{ maxWidth: "calc(100% - 48px)" }}>
                      <Paper
                        sx={{
                          ...
                          background:
                            msg.role === "user"
                              ? "linear-gradient(135deg, rgba(138,84,255,0.25), rgba(159,110,255,0.15))"
                              : msg.isError
                                ? "rgba(239,68,68,0.1)"
                      ...
                      >
                        ...
                        {msg.sources && msg.sources.length > 0 && (
                          ...
                          >
                            ...
                            >
                              <AutoAwesome sx={{ fontSize: 14 }} /> Sources from
                              document:
                            </Typography>
