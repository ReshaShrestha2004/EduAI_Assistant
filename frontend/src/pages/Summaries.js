          ...
          {summary && !generating && (
            <ResultCard sx={{ animation: `${fadeIn} 0.6s ease-out 0.2s backwards`, mt: 3 }}>
              ...
              <Paper sx={{ p: 3, background: 'rgba(0, 0, 0, 0.2)', borderRadius: '16px', mb: 3 }}>
                <ReactMarkdown
    components={{
      h1: ({ children }) => <Typography variant="h5" sx={{ color: '#FFFFFF', fontWeight: 800, mt: 2, mb: 1 }}>{children}</Typography>,
      h2: ({ children }) => <Typography variant="h6" sx={{ color: '#B88CFF', fontWeight: 700, mt: 2, mb: 1 }}>{children}</Typography>,
      h3: ({ children }) => <Typography sx={{ color: '#9F6EFF', fontWeight: 700, fontSize: '16px', mt: 1.5, mb: 0.5 }}>{children}</Typography>,
      h4: ({ children }) => <Typography sx={{ color: '#8A54FF', fontWeight: 600, fontSize: '15px', mt: 1, mb: 0.5 }}>{children}</Typography>,
      p: ({ children }) => <Typography sx={{ color: 'rgba(255, 255, 255, 0.9)', lineHeight: 1.8, mb: 1.5 }}>{children}</Typography>,
      li: ({ children }) => <Typography component="li" sx={{ color: 'rgba(255, 255, 255, 0.85)', lineHeight: 1.8, ml: 2, mb: 0.5 }}>{children}</Typography>,
