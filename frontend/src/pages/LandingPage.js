...
const FeatureIcon = styled(Box)(({ gradient, iconcolor }) => ({
  ...
  height: '80px',
  borderRadius: '20px',
  background: gradient || 'linear-gradient(135deg, rgba(138, 84, 255, 0.2) 0%, rgba(159, 110, 255, 0.2) 100%)',
  display: 'flex',
  alignItems: 'center',
...
export default function LandingPage() {
  ...
  const features = [
    {
      ...
      description: 'Get instant, intelligent summaries of your study materials in seconds',
      color: '#8A54FF',
    ...
    },
    {
      ...
      description: 'Save time and improve retention with AI-powered learning tools',
      color: '#6BCF7F',
  ...
  return (
    <Box sx={{ background: '#0F0B1A' }}>
          ...
          >
            ...
            <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center', mb: 6 }}>
              ...
              <Typography
                ...
                sx={{
                  fontWeight: 900,
                  background: 'linear-gradient(135deg, #FFFFFF 0%, #B88CFF 100%)',
                  backgroundClip: 'text',
            ...
            >
              ...
              <Box
                component="span"
                sx={{
                  background: 'linear-gradient(135deg, #8A54FF 0%, #B88CFF 100%)',
                  backgroundClip: 'text',
                  WebkitBackgroundClip: 'text',
                  WebkitTextFillColor: 'transparent',
                }}
            ...
            >
              Transform your learning experience with AI. Generate summaries, flashcards,
              and quizzes from any document in seconds.
            </Typography>
      ...
      <Box sx={{ py: 12, background: 'linear-gradient(180deg, #0F0B1A 0%, #1A122A 100%)' }}>
              ...
              <Grid item xs={12} sm={6} md={4} key={index} sx={{ display: 'flex' }}>
                ...
                >
                  <CardContent sx={{ 
                    ...
                    <FeatureIcon gradient={feature.gradient} iconcolor={feature.color}>
                      {feature.icon}
                    </FeatureIcon>
                    <Typography
                      variant="h5"
      ...
      <Box sx={{ py: 12, background: 'linear-gradient(180deg, #1A122A 0%, #0F0B1A 100%)' }}>
        <Container maxWidth="lg">
          <Typography
            variant="h2"
            sx={{
            ...
            <Grid container spacing={3}>
              {benefits.map((benefit, index) => (
                <Grid item xs={12} sm={6} md={4} key={index}>
                  ...
                  >
                    <CheckCircle sx={{ color: '#8A54FF', fontSize: 28, flexShrink: 0 }} />
                    <Typography 
                      sx={{ 
                        color: '#FFFFFF', 
                        fontSize: '16px', 
      ...
      >
        ...
        <Container maxWidth="md" sx={{ position: 'relative', zIndex: 2 }}>
          <Box sx={{ textAlign: 'center' }}>
            ...
            >
              Join thousands of students who are already studying smarter with EduAI
            </Typography>
            <GradientButton
              size="large"
              endIcon={<ArrowForward />}
      ...
      >
        <Container>
          ...
          >
            © 2024 EduAI Assistant. All rights reserved.
          </Typography>
        </Container>
      </Box>
    </Box>
